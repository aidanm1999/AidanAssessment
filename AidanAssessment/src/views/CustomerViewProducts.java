...
public class CustomerViewProducts extends javax.swing.JFrame {
    ...
    private void btnAddToBasketActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddToBasketActionPerformed
        ...
        {
            lblMessage.setText("Select customer first");
        }
        else
        {
            int quantity = comboBoxQuantity.getSelectedIndex();
            Order order = new Order();
            OrderLine orderLine = new OrderLine (order, selectedProduct);
            lblMessage.setText("Added to Order");
            
            
            
            DefaultListModel model = (DefaultListModel) lstCategory.getModel();
            int selectedIndex = lstCategory.getSelectedIndex();
            model.remove(selectedIndex);
        }
        
        DBManager db = new DBManager();
        db.findOrder(loggedInCustomer, selectedProduct, Integer.valueOf((String)comboBoxQuantity.getSelectedItem())); 
