...
public class CustomerEditDetails extends javax.swing.JFrame {
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if(!txtUsername.getText().isEmpty() && !txtPassword.getText().isEmpty() && !txtFirstName.getText().isEmpty() && !txtLastName.getText().isEmpty() && !txtAddressLine1.getText().isEmpty() && !txtTown.getText().isEmpty() && !txtPostcode.getText().isEmpty())
        {
            ...
            loggedInCustomer.setFirstName(txtFirstName.getText());
            loggedInCustomer.setLastName(txtLastName.getText());
            loggedInCustomer.setAddressLine1(txtAddressLine1.getText());
            loggedInCustomer.setAddressLine2(txtAddressLine2.getText());
            loggedInCustomer.setTown(txtTown.getText());
            loggedInCustomer.setPostcode(txtPostcode.getText());
            
            CustomerDBManager cdb = new CustomerDBManager();
            if(cdb.updateCustomer(loggedInCustomer)) { lblMessage.setText("Update Successful"); }
            else { lblMessage.setText("Error"); }
        }
        else
